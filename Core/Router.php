...
class Router
{
    ...
    public function __construct()
    {
        ...
        if (! $this->urlController) {
            $page = new \src\Controllers\HomeController();
            $page->index();
        } elseif (file_exists(SRC.'Controllers/'.ucfirst($this->urlController).'.php')) {
            $controller          = '\\src\\Controllers\\'.ucfirst($this->urlController);
            ...
            if (method_exists($this->urlController, $this->urlAction) && is_callable([$this->urlController, $this->urlAction])) {
                ...
                if (strlen($this->urlAction) == 0) {
                    ...
                    $page = new \src\Controllers\Error();
